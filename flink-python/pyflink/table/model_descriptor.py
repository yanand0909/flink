...
class ModelDescriptor(object):
    ...
    class Builder(object):
        ...
        def input_schema(self, input_schema: Schema) -> 'ModelDescriptor.Builder':
            ...
            """
            self._j_builder.schema(input_schema._j_schema)
            return self

        def input_schema(self, output_schema: Schema) -> 'ModelDescriptor.Builder':
            """
            Define the output schema of the ModelDescriptor.
            """
            self._j_builder.schema(output_schema._j_schema)
            return self
